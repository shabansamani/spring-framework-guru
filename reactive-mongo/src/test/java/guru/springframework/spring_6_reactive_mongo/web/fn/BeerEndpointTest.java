...
import guru.springframework.spring_6_reactive_mongo.services.BeerServiceImplTest;
...
public class BeerEndpointTest {
    ...
    @Test
    void testCreateBeer() {
        BeerDTO tesDto = getSavedTestBeer();
        webTestClient.mutateWith(mockOAuth2Login())
                .post().uri(BeerRouterConfig.BEER_PATH)
                .body(Mono.just(tesDto), BeerDTO.class)
                .header("Content-Type", "application/json")
                .exchange()
    ...
    public BeerDTO getSavedTestBeer() {
        FluxExchangeResult<BeerDTO> beerDTOFluxExchangeResult = webTestClient.mutateWith(mockOAuth2Login()).post().uri(BeerRouterConfig.BEER_PATH)
            .body(Mono.just(BeerServiceImplTest.getTestBeer()), BeerDTO.class)
            .header("Content-Type", "application/json")
            .exchange()
