...
import guru.springframework.spring_6_restclient.client.BeerClient;
import guru.springframework.spring_6_restclient.client.BeerClientImpl;
import guru.springframework.spring_6_restclient.config.OAuthClientInterceptor;
import guru.springframework.spring_6_restclient.config.RestTemplateBuilderConfig;
...
public class BeerClientMockTest {
  ...
  public static class TestConfig {
    ...
    OAuth2AuthorizedClientService auth2AuthorizedClientService(
        ClientRegistrationRepository clientRegistrationRepository) {
      return (OAuth2AuthorizedClientService) new InMemoryOAuth2AuthorizedClientService(clientRegistrationRepository);
    }
